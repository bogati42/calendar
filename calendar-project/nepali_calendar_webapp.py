...
# --- New function for Nepali numerals ---
def convert_to_nepali_numeral(number):
    """Converts an English numeral string or integer to a Nepali numeral string."""
    nepali_numerals_map = {
        '0': '०', '1': '१', '2': '२', '3': '३', '4': '४',
        '5': '५', '6': '६', '7': '७', '8': '८', '9': '९'
    }
    return ''.join(nepali_numerals_map.get(digit, digit) for digit in str(number))

app.jinja_env.globals.update(convert_to_nepali_numeral=convert_to_nepali_numeral)
# --- End new function ---
